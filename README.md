...
- **Run it:** `uv venv && uv pip install -e ".[dev,api,mcp]" && uv run pytest` (253 tests, offline) — or `make verify` for the full gate (tests · lint · doc-numbers · evidence · red-team).
...
Complete and tested — **253 passing tests, lint-clean, fully offline**: the signed
