...
server, with an independent `/verify` endpoint and a production UI. 246 passing tests.
...
> **4/** Open source (MIT, 246 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
