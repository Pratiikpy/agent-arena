...
server, with an independent `/verify` endpoint and a production UI. 245 passing tests.
...
> **4/** Open source (MIT, 245 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
