...
server, with an independent `/verify` endpoint and a production UI. 268 passing tests.
...
> **4/** Open source (MIT, 268 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
