...
server, with an independent `/verify` endpoint and a production UI. 247 passing tests.
...
> **4/** Open source (MIT, 247 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
