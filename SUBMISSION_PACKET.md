...
server, with an independent `/verify` endpoint and a production UI. 250 passing tests.
...
> **4/** Open source (MIT, 250 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
