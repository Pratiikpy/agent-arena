...
server, with an independent `/verify` endpoint and a production UI. 267 passing tests.
...
> **4/** Open source (MIT, 267 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
