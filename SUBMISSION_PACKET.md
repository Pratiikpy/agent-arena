...
server, with an independent `/verify` endpoint and a production UI. 243 passing tests.
...
> **4/** Open source (MIT, 243 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
