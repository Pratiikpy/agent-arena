...
server, with an independent `/verify` endpoint and a production UI. 311 passing tests.
...
> **4/** Open source (MIT, 311 tests, CI-green): https://github.com/narutopyy/agent-arena —
