...
server, with an independent `/verify` endpoint and a production UI. 244 passing tests.
...
> **4/** Open source (MIT, 244 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
