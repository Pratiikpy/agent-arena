...
server, with an independent `/verify` endpoint and a production UI. 330 passing tests.
...
- **The Lab — seven signed/sandboxed innovations** (all in `evidence/`, served over HTTP, shown
  ...
  real technicals + funding). 330 tests, CI-green.
...
> **4/** Open source (MIT, 330 tests, CI-green): https://github.com/narutopyy/agent-arena —
