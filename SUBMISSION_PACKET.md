...
server, with an independent `/verify` endpoint and a production UI. 253 passing tests.
...
> **4/** Open source (MIT, 253 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
