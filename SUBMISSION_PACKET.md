...
server, with an independent `/verify` endpoint and a production UI. 251 passing tests.
...
> **4/** Open source (MIT, 251 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
