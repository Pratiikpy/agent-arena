...
server, with an independent `/verify` endpoint and a production UI. 248 passing tests.
...
> **4/** Open source (MIT, 248 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
