...
server, with an independent `/verify` endpoint and a production UI. 254 passing tests.
...
> **4/** Open source (MIT, 254 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
