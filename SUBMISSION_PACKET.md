...
server, with an independent `/verify` endpoint and a production UI. 255 passing tests.
...
> **4/** Open source (MIT, 255 tests, CI-green): https://github.com/Pratiikpy/agent-arena —
