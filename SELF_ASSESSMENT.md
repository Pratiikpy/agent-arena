...
| Runnability | 8/10 | Live signed firewall + **public deploy**, real Bitget data, four published Playbooks, 243 tests — but paper, not real-money yet |
...
on-platform backtests, a live Qwen debate agent, and 243 passing offline tests. The public
